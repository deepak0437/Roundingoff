# Generated by Django 4.0.4 on 2022-10-17 04:24
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Numbers', '0034_squarerootoffractioncalculator'),
    ]

    operations = [
        migrations.CreateModel(
            name='numberminuspercentCalculator',
            fields=[
        ...
        migrations.CreateModel(
            name='numberpluspercentCalculator',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inputEnter', models.CharField(max_length=250)),
                ('detailStep', models.TextField()),
